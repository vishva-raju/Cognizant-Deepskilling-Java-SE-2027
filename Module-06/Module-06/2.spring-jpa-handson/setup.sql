-- ============================================================
-- Hands On 1: Create schema
-- Run this first: mysql -u root -p   then paste, or
...
-- Sample inserts referenced early in Hands On 1
insert into country values ('IN', 'India');
insert into country values ('US', 'United States of America');

-- ============================================================
-- Hands On 5: Delete sample rows, then populate full country list
-- ============================================================
delete from country;
